...
from kryten_llm.models.config import LLMConfig, FormattingConfig, PersonalityConfig
...
class ResponseFormatter:
    ...
    def format_response(self, response: str) -> list[str]:
        ...
        try:
            ...
            if self.formatting_config.enable_emoji_limiting and self.formatting_config.max_emoji_per_message:
                parts = [self._limit_emoji(part, self.formatting_config.max_emoji_per_message) for part in parts]
